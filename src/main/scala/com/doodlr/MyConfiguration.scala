...
object MyConfiguration {
  ...
  // this function returns Config, in a Config, there is a with fallback method, hence we call the with fallback method when spawnning our actors for remoting
